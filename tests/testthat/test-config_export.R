...
test_that("EXPORT_ASPECT_RATIO_MIN has correct value", {
  ...
  expect_true(
    exists("EXPORT_ASPECT_RATIO_MIN"),
  ...
  expect_true(
    EXPORT_ASPECT_RATIO_MIN > 0 && EXPORT_ASPECT_RATIO_MIN < 1,
...
test_that("EXPORT_ASPECT_RATIO_MAX has correct value", {
  ...
  expect_true(
    exists("EXPORT_ASPECT_RATIO_MAX"),
...
test_that("EXPORT_TITLE_MAX_LENGTH has correct value", {
  ...
  expect_true(
    exists("EXPORT_TITLE_MAX_LENGTH"),
...
test_that("EXPORT_DESCRIPTION_MAX_LENGTH has correct value", {
  ...
  expect_true(
    exists("EXPORT_DESCRIPTION_MAX_LENGTH"),
  ...
  expect_true(
    EXPORT_DESCRIPTION_MAX_LENGTH > EXPORT_TITLE_MAX_LENGTH,
...
test_that("EXPORT_DEPARTMENT_MAX_LENGTH has correct value", {
  ...
  expect_true(
    exists("EXPORT_DEPARTMENT_MAX_LENGTH"),
  ...
  expect_true(
    EXPORT_DEPARTMENT_MAX_LENGTH > 0,
...
test_that("EXPORT_FILENAME_PREFIX has correct value", {
  ...
  expect_true(
    nchar(EXPORT_FILENAME_PREFIX) > 0,
...
test_that("EXPORT_FILENAME_SEPARATOR has correct value", {
  ...
  expect_true(
    exists("EXPORT_FILENAME_SEPARATOR"),
  ...
  expect_true(
    nchar(EXPORT_FILENAME_SEPARATOR) == 1,
...
test_that("EXPORT_VALIDATION_RULES has correct structure", {
  ...
  expect_true(
    exists("EXPORT_VALIDATION_RULES"),
  ...
  required_fields <- c(
    "min_width_px", "max_width_px", "min_height_px",
...
test_that("EXPORT_VALIDATION_RULES DPI constraints are valid", {
  ...
  expect_lt(
    EXPORT_VALIDATION_RULES$min_dpi,
  ...
  for (dpi in EXPORT_DPI_OPTIONS) {
    expect_true(
      dpi >= EXPORT_VALIDATION_RULES$min_dpi &&
...
test_that("EXPORT_VALIDATION_RULES PDF field requirements are valid", {
  ...
  overlap <- intersect(
    EXPORT_VALIDATION_RULES$pdf_required_fields,
...
test_that("Size presets are compatible with validation rules", {
  ...
  for (preset_name in names(EXPORT_SIZE_PRESETS)) {
    ...
    expect_true(
      preset$dpi >= EXPORT_VALIDATION_RULES$min_dpi &&
